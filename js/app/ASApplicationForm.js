var ASApplicationForm = (function($) {
			...
			methods : {
				fetchData : function() {
					...
					$.ajax({
						dataType : 'json',
						type : 'POST',
						url : '/customer-center/as-application-form/data',
				...
				onSubmit : function(e) {
					...
					$.ajax({dataType : 'json', type : 'post',
						contentType : 'application/json',
						url : '/customer-center/as-application-form/submit',
	...
	var goList = function (){
		location.href = "/customer-center/as-application-main";
	};
